            ...
            <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
                <div className="mb-12 flex flex-col md:flex-row justify-between items-end gap-6">
                    <div>
                        ...
                        <p className="mt-2 text-lg text-slate-500">Manage your resumes and track your job applications.</p>
                    </div>
                    <div className="flex gap-4">
                        <Button variant="outline" size="lg" onClick={() => router.push('/builder')} className="bg-white border-slate-200">
                            <Upload className="mr-2 h-5 w-5" />
                            Upload Existing
                        </Button>
                        <Button size="lg" onClick={() => router.push('/builder/scratch')} className="shadow-lg shadow-primary/25 bg-indigo-600">
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <div className="rounded-xl border border-slate-200 bg-white p-8 text-center shadow-sm">
                                ...
                                <Button size="lg" onClick={() => router.push('/builder')} className="shadow-xl shadow-primary/20 w-full sm:w-auto">
                                    <Plus className="mr-2 h-5 w-5" />
                            ...
                            <div className="pt-8 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
                                <p className="text-center text-xs font-semibold uppercase tracking-wider text-slate-400 mb-4">Trusted by candidates at</p>
